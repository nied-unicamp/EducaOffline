...
import { fileUploadedOfflineDeletedAdapter } from './file-uploaded.offline.state';

const offlineStateSelector = createSelector(
  FileUploadedSelectors.state,
  (state) => state.offline
);
...
const selectDeletedIds = createSelector(
  selectDeletedState,
  fileUploadedOfflineDeletedAdapter.getSelectors().selectIds,
);
...
const selectDeletedEntities = createSelector(
  selectDeletedState,
  fileUploadedOfflineDeletedAdapter.getSelectors().selectEntities
);
...
export const FileUploadedOfflineSelectors = {
